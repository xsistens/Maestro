...
interface SettingsModalProps {
	...
	initialTab?: 'general' | 'display' | 'llm' | 'shortcuts' | 'theme' | 'notifications' | 'aicommands' | 'vcs' | 'ssh';
	hasNoAgents?: boolean;
...
export const SettingsModal = memo(function SettingsModal(props: SettingsModalProps) {
	...
	const [activeTab, setActiveTab] = useState<
		'general' | 'display' | 'llm' | 'shortcuts' | 'theme' | 'notifications' | 'aicommands' | 'vcs' | 'ssh'
	>('general');
	...
	useEffect(() => {
		...
		const handleTabNavigation = (e: KeyboardEvent) => {
			const tabs: Array<
				'general' | 'display' | 'vcs' | 'llm' | 'shortcuts' | 'theme' | 'notifications' | 'aicommands' | 'ssh'
			> = FEATURE_FLAGS.LLM_SETTINGS
				? ['general', 'display', 'vcs', 'llm', 'shortcuts', 'theme', 'notifications', 'aicommands', 'ssh']
				: ['general', 'display', 'vcs', 'shortcuts', 'theme', 'notifications', 'aicommands', 'ssh'];
